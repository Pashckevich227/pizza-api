...
@router.get("/pizza/{id}", response_model=Pizza)
...
@router.get("/pizza/", response_model=list[Pizza], status_code=status.HTTP_200_OK)
...
@router.post("/pizza/", response_model=PizzaCreate, status_code=status.HTTP_201_CREATED)
